...
function openBook()
{
 /*   let table = document.getElementById("bookCard");
    table.innerHTML = "";
    let row = table.insertRow(0);
    let cell1 = row.insertCell(0);
    let cell2 = row.insertCell(1);
    let cell3 = row.insertCell(2);
    cell1.innerHTML = selected.id;
    cell2.innerHTML = selected.name;
    cell3.innerHTML = selected.author;*/
